...
describe('TAG_CATEGORY_MAP_V2', () => {
  it('maps tags to v2 classifications', () => {
    expect(TAG_CATEGORY_MAP_V2['/search']).toEqual({ category: 'WEB_SEARCH', complexity: 'normal', action: false, focus_shift: null })
    expect(TAG_CATEGORY_MAP_V2['/research']).toEqual({ category: 'RESEARCH', complexity: 'normal', action: false, focus_shift: null })
    expect(TAG_CATEGORY_MAP_V2['/image']).toEqual({ category: 'IMAGE_GEN', complexity: 'normal', action: false, focus_shift: null })
    expect(TAG_CATEGORY_MAP_V2['/tool']).toEqual({ category: 'PRIMARY', complexity: 'normal', action: true, focus_shift: null })
    expect(TAG_CATEGORY_MAP_V2['/code']).toEqual({ category: 'PRIMARY', complexity: 'hard', action: false, focus_shift: null })
  })
})
