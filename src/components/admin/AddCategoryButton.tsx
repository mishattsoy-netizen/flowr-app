...
export default function AddCategoryButton({ platform, category }: { platform: 'app' | 'telegram', category: string }) {
  ...
  return (
    <button 
      ...
      disabled={isPending}
      className="group flex flex-col items-center justify-center gap-3 p-8 bg-white/[0.02] rounded-big hover:bg-accent/5 transition-all w-full"
    >
      <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-accent/10 transition-all">
