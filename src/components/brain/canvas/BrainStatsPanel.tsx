  ...
  return (
    <div className="flex items-center gap-4 px-4 py-2.5 bg-panel/98 backdrop-blur-xl border border-[var(--bone-12)] shadow-[0_4px_16px_rgba(0,0,0,0.14)] rounded-[14px] select-none canvas-floating-panel">
      <div className="flex items-center gap-2">
        <StickyNote className="w-3.5 h-3.5 text-[var(--bone-40)]" strokeWidth={2} />
      ...
      <div className="flex items-center gap-2">
        <Link2 className="w-3.5 h-3.5 text-[var(--bone-40)]" strokeWidth={2} />
      ...
      <div className="flex items-center gap-2.5" title={`${used.toLocaleString()} / ${limit.toLocaleString()} tokens`}>
        <Gauge className={cn("w-3.5 h-3.5", isOverBudget ? "text-danger" : isNearBudget ? "text-amber-400" : "text-[var(--bone-40)]")} strokeWidth={2} />
