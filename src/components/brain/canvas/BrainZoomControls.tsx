      ...
      <div className="flex items-center h-8 bg-panel/98 backdrop-blur-xl border border-[var(--bone-12)] shadow-[0_4px_12px_rgba(0,0,0,0.12)] rounded-[8px] p-[3px] canvas-floating-panel">
        <Tooltip content="Zoom Out">
          <button
            type="button"
            onClick={onZoomOut}
            className="group w-7 h-[26px] rounded-[6px] flex items-center justify-center text-[var(--bone-100)] hover:bg-[var(--app-dark)] active:bg-[var(--bone-15)] cursor-pointer transition-all duration-150 ease-in-out"
          >
