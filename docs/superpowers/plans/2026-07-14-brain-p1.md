...
| File | Responsibility |
|---|---|
| `supabase/migrations/20260714000005_brain_tables.sql` (create) | Tables, RLS, `entities.description`, `bot_session_states.pinned_brain_version`, `bot_memories` import, tier config seed |
...
**Files:**
- Create: `supabase/migrations/20260714000005_brain_tables.sql`
...
```bash
git add supabase/migrations/20260714000005_brain_tables.sql src/lib/bot/services/brainTypes.ts
...
1. Run `supabase/migrations/20260714000005_brain_tables.sql` in Supabase (owner).
